 ...
 * PLACEHOLDER: quyidagi manzil, telefon, Instagram va katalog media URL larni
 * haqiqiy ma'lumot bilan almashtiring.
 */
const HARDOIL_CONFIG = {
  ...
  home: {
    ...
    // Asosiy sahifadagi ko'rinish kartochkalari (ASLZAR uslubida)
    previews: [
      {
        image:
          "https://images.unsplash.com/photo-1619642751034-765dfdf7f58e?w=600&h=400&fit=crop",
        alt: "Motor moyi",
      },
      {
        image:
  ...
  catalogItems: [
    ...
    },
    {
      id: 2,
      type: "image",
      title: "Sintetik motor moyi",
      thumb:
        "https://images.unsplash.com/photo-1619642751034-765dfdf7f58e?w=400&h=400&fit=crop",
    ...
    },
    {
      ...
      title: "Moy filtri",
      thumb:
        "https://images.unsplash.com/photo-1625047509248-ec889c063d24?w=400&h=400&fit=crop",
  ...
  other: {
    title: "BOSHQA",
    subtitle: "Platformadagi qo'shimcha imkoniyatlar",
    menu: [
      { id: "location", icon: "📍", label: "Manzil va filiallar" },
      { id: "feedback", icon: "💬", label: "Taklif va shikoyatlar" },
      { id: "instagram", icon: "📸", label: "Hardoil rasmiy Instagram" },
    ],
  },

  // PLACEHOLDER — haqiqiy manzil va telefonni kiriting
  location: {
    title: "Manzil va filiallar",
    address: "Toshkent sh., [PLACEHOLDER] ko'cha, 1-uy",
    workHours: "Dush–Shan: 09:00 – 20:00 | Yakshan: 10:00 – 18:00",
    phone: "+998 90 000 00 00",
    mapUrl: "https://maps.google.com/?q=Toshkent+Hardoil",
  },

  feedback: {
    title: "Taklif va shikoyatlar",
    subtitle: "Fikringiz biz uchun muhim. Tez orada javob beramiz.",
    fields: {
      name: "Ismingiz",
      phone: "Telefon raqam",
      message: "Xabar",
  ...
  // PLACEHOLDER — haqiqiy Instagram sahifangiz
  instagram: {
